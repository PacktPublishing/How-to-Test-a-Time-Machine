...
public class LocalisedFilePageClass {
    ...
    private static final Path objectsPath_EN_UK = Paths.get(System.getProperty("user.dir"), "src", "test", "java", "com", "packtpub", "LocalizationFOMMultipleTextFiles" , "ElementsEN_UK.xml");
    private static final Path objectsPath_ES_ES = Paths.get(System.getProperty("user.dir"), "src", "test", "java", "com", "packtpub", "LocalizationFOMMultipleTextFiles" , "ElementsES_ES.xml");
